window.addEventListener('DOMContentLoaded', function(){
  ...
  class OptionButton{ 
    ...
    makePackageButton(){
        ...
        $(`#packageOption${this.optionWord}>article`).find("article").css("background-image", "url('./img/iconPackage.png')");
    ...
    makePackageButtonSimple(){
        ...
        $(`#packageOptionSimple${this.optionWord}>article`).find("article").css("background-image", "url('./img/iconPackage.png')");
    ...
    makeSpoonButton(optionSpoonCount){
        ...
        $(`#spoonOption${this.optionWord}>article`).find("article").css("background-image", "url('./img/iconSpoon.png')");
    ...
    makeCandleButton(){
        ...
        $(`#candleOption${this.optionWord}>article`).find("article").css("background-image", "url('./img/iconCandle.png')");
    ...
    makeShotButton(){
        ...
        $(`#shotOption${this.optionWord}>article`).find("article").css("background-image", "url('./img/iconShot.png')");
    ...
    makeSyrupButton(){
        ...
        $(`#syrupOption${this.optionWord}>article`).find("article").css("background-image", "url('./img/iconSyrup.png')");
    ...
    makeCupButton(){
        ...
        $(`#cupOption${this.optionWord}>article`).find("article").css("background-image", "url('./img/iconconecup.png')");
  ...
  class Product{  
    ...
    printProduct(tabNum){
      ...
      if(this.tabNum == 0) {
        $("#productPage1 .cardProduct:nth-child(5) .crownBox").css("background-image", "url('./img/icon_name_jisu.svg')");
      } else if(this.tabNum == 2) {
        $("#productPage1 .cardProduct:nth-child(1) .crownBox").css("background-image", "url('./img/icon_name_gyeongho.svg')");
      }
    }
    productEventControl(){
    ...
    arrowBtnControl(){ 
      if(this.paginationArr[this.tabNum] == 0){
        $("#btnLeftProduct div").css({"background-image":"url('./img/grayLeft.png')"});
        $("#btnRightProduct div").css({"background-image":"url('./img/grayRight.png')"});
      }
      else{
        if(this.pagination == 0){
          $("#btnLeftProduct div").css({"background-image":"url('./img/grayLeft.png')"});
          $("#btnRightProduct div").css({"background-image":"url('./img/pinkRight.svg')"}); 
        }
        else if(this.pagination == this.paginationArr[this.tabNum]){
          $("#btnLeftProduct div").css({"background-image":"url('./img/pinkLeft.svg')"});
          $("#btnRightProduct div").css({"background-image":"url('./img/grayRight.png')"});   
        }
        else{
          $("#btnLeftProduct div").css({"background-image":"url('./img/pinkLeft.svg')"});
  ...
  class CartProduct{
    ...
    buttonCheck(){
      ...
      if(this.cartList.length > 3){
        ...
        $("#btnBannerRight>div").css("background-image", "url('./img/pinkRight.svg')");
      }
      else{
        $("#btnBannerRight>div").css("background-image", "url('./img/grayRight.png')");
      }
    }
    buttonEventContol(){
      $("#btnBannerLeft").on("click", ()=>{
        if(this.cartIndex){
          ...
          this.cartIndex--;
          if(this.cartIndex == 0){
            $("#btnBannerLeft>div").css("background-image", "url('./img/grayLeft.png')");  
          }
          $("#btnBannerRight>div").css("background-image", "url('./img/pinkRight.svg')");   
        }
      });
      $("#btnBannerRight").on("click", ()=>{
        if(this.cartIndex != this.cartPage && this.cartListCount > 3){
          ...
          $("#btnBannerLeft>div").css("background-image", "url('./img/pinkLeft.svg')");  
        }
      });
    ...
    class FlavorPage{
      ...
      arrowBtnControl(){ 
        if(this.pagination == 0){
          ...
          $("#btnLeftFlavor div").css({"background-image":"url('./img/grayLeft.png')"});
          $("#btnRightFlavor div").css({"background-image":"url('./img/pinkRight.svg')"}); 
        }
        else if(this.pagination == this.paginationCount){
          
          $("#btnLeftFlavor div").css({"background-image":"url('./img/pinkLeft.svg')"});
          $("#btnRightFlavor div").css({"background-image":"url('./img/grayRight.png')"});   
          }
        else{
      ...
      flavorAreaCreate(){
        ...
        while(i<product.productSelect.unit){
          ...
          $(`.cardSelectFlavor:nth-child(${i+1}) span`).on("click", (e)=>{
            $(e.target).closest("div").find("span").prev().css("background-image", "url('./img/icon_ice.svg')");
      ...
      // 신메뉴, 인기순위, 신상품 스티커 생성
      crownShow(){
        $("#flavorPage1 .cardFlavors:nth-child(1) .crownBox").css("background-image", "url('./img/new.png')");
        $("#flavorPage1 .cardFlavors:nth-child(2) .crownBox").css("background-image", "url('./img/crown1.png')");
        $("#flavorPage1 .cardFlavors:nth-child(3) .crownBox").css("background-image", "url('./img/crown2.png')");
        $("#flavorPage1 .cardFlavors:nth-child(4) .crownBox").css("background-image", "url('./img/crown3.png')");
        $("#flavorPage1 .cardFlavors:nth-child(5) .crownBox").css("background-image", "url('./img/icon_name_pureum.svg')");
        $("#flavorPage1 .cardFlavors:nth-child(6) .crownBox").css("background-image", "url('./img/icon_name_eunji.svg')");
        $("#flavorPage1 .cardFlavors:nth-child(7) .crownBox").css("background-image", "url('./img/icon_name_junyoung.svg')");
      }
      getFlavorList(){
    ...
    clickEventControl(){
      ...
      $("#selectPoint span").each(function(i){
        $(this).on("click", (e)=>{
          ...
          $(`#selectPoint span:nth-child(1) div`).css("background-image", "url('./img/iconInnerSave.svg')");
          $(`#selectPoint span:nth-child(2) div`).css("background-image", "url('./img/iconInnerUse.svg')");
          switch(i){
            case 0:
              ...
              $(`#selectPoint span:nth-child(${i+1}) div`).css("background-image", "url('./img/iconInnerSavepink.svg')");
            ...
            case 1:
              ...
              $(`#selectPoint span:nth-child(${i+1}) div`).css("background-image", "url('./img/iconInnerUsePink.svg')");
    ...
    function btnNextINFunc(){
      $(btnNextIN).on('click', function(event){
        ...
        setTimeout(()=>{
          ...
          $(".lottie_container").append('<lottie-player src="./json/fireWork.json" background="transparent" speed="1" autoplay></lottie-player>'); 
        },1000);
      })
    }
  } 
  ...
  let firstKeyHome = 0;
  let logoutCount = 60;
  let touchAudio = new Audio('./js/sound.mp3');
  ...
  (() => {
    ...
    while(i < randomArray.length){
      $(".wrapHomeSlider").append($("<li>").css("background-image", `url(img/mainbanner${(randomArray[i] + 1)}.jpg)`));
    i++;}
    $(".wrapHomeSlider").append($("<li>").css("background-image", `url(img/mainbanner${(randomArray[0] + 1)}.jpg)`));
    count = 0;
    setInterval(() =>{
      count++;
    ...
    changePageAdmin(){
      switch(this.tabNum){
        case 0:
          ...
          $(`#admin3DImg`).css({background: `url('./img/day_3d.png') no-repeat center center/cover`, transform: 'scale(1)', width: '31rem', top: '-1rem', right: '-5rem'});
        ...
        case 1:
          ...
          $(`#viewTotalAdmin`).css({display: 'flex'});
          $(`#admin3DImg`).css({background: `url('./img/month_3d.svg') no-repeat center center/cover`, transform: 'scale(0.7)', width: '45rem', top: '-3rem', right: '-5rem'});
          $(`#viewTotalAdmin`).parent().css({height: '44rem'});
          $(`#adminTypeTitle`).css({marginTop: '12rem'})
          $(`#mainAdminWrap`).css({height: '96rem'});
          $(`#listDescAdmin`).css({height: '80rem'});
        ...
        case 2:
          ...
          $(`#admin3DImg`).css({background: `url('./img/rank_3d.svg') no-repeat center center/cover`, transform: 'scale(1)', width: '31rem', top: '-3rem', right: '-1rem'});
  ...
  let adminTable;
	...
	$.ajax({
	  ...
	  success: function(data) {
			console.log(data)
			adminTable = new AdminTable(data);
	  },
	  error: function(){
			console.log('err')
		}
